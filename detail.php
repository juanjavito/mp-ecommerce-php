<?php
// verifico variables post
if (!isset($_POST['price']) || !isset($_POST['title']) || !isset($_POST['unit'])) {
                                ...
                                <div class="width:60%">
                                    ...
                                    <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                        <div class="as-producttile-titlepricewraper" style="min-height: 128px;">
                                            ...
                                            <h3 >
                                                <b>Precio: </b> <?php echo "$" . $_POST['price'] ?>
                                            </h3>
                                            <h3 >
                                                <b>Cantidad: </b> <?php echo $_POST['unit'] ?>
                                            </h3>
                                        </div>
